const SHDW_URL =
  "https://shdw-drive.genesysgo.net/GwJapVHVvfM4Mw4sWszkzywncUWuxxPd6s9VuFfXRgie";

export const LOGO_TEXT = `${SHDW_URL}/logo_text.png`;
export const HERO_LOGO = `${SHDW_URL}/long_wen.png`;

export const LOGO_SQUARE = `${SHDW_URL}/logo_300.png`;
export const LOGO_CAT = `${SHDW_URL}/wen_head.png`;
...
export const ASSET_DASH_LOGO = `${SHDW_URL}/asset-dash-logo.svg`;
export const JUPITER_LOGO = `${SHDW_URL}/jupiter-logo.svg`;
export const MAGIC_EDEN_LOGO = `${SHDW_URL}/magic-eden-logo.svg`;
